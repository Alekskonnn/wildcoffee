...
// other utils
export const getSymbolX = (reelIndex: number) => REEL_X_PITCH * (reelIndex + REEL_PADDING);
export const getSymbolY = (symbolIndexOfBoard: number) => (symbolIndexOfBoard + 0.5) * REEL_Y_PITCH;
